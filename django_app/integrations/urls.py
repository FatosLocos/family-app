...
urlpatterns = [
    ...
    path("api/openclaw/reizen/<int:trip_id>/bijwerken/", openclaw_views.api_update_trip, name="api_openclaw_update_trip"),
    path("api/openclaw/reizen/<int:trip_id>/tussenstops/toevoegen/", openclaw_views.api_add_trip_stop, name="api_openclaw_add_trip_stop"),
    path("api/openclaw/reizen/<int:trip_id>/takenlijst/koppelen/", openclaw_views.api_link_trip_task_list, name="api_openclaw_link_trip_task_list"),
    path("api/openclaw/reizen/<int:trip_id>/documenten/toevoegen/", openclaw_views.api_add_trip_document, name="api_openclaw_add_trip_document"),
    path("api/openclaw/reizen/<int:trip_id>/ideeen/toevoegen/", openclaw_views.api_add_trip_idea, name="api_openclaw_add_trip_idea"),
    ...
    path("imap/configuratie/", views.save_imap_config, name="save_imap_config"),
