# Gearchiveerde Next.js-versie

> Deze map is uitsluitend een historische fallback. De actieve Family App staat in [`../../django_app/`](../../django_app/) en draait op Django. Voeg hier geen nieuwe functionaliteit of deploymentconfiguratie toe.
